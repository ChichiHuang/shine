    ...
    <div class="wrapper">
      <div style="width:100%;    margin-left: auto; margin-right: auto;" >
        ...
        <section class="content-header" >
          <h1><span style="color:#FF7634;"><?php echo $site_title;?></span>-新增大紀事</h1>  
        </section>
        <!-- 主要內容 -->
    ...
    $('#submit_form').click(function() {
      ...
      if(!$('input[name="title"]').val()) {
        ...
        $.ajax({
          ...
          data:{action:'insert',title:title,date:date,content:content,token:token,type:milestone_type},
          type : "POST",
            ...
            if(data.result==1)
            {
              Lobibox.alert('success', {
                ...
                callback: function(lobibox, type){
                  ...
                  parent.location.href="milestone_list.php?token="+token+'&type='+milestone_type;
