      ...
      <aside class="main-sidebar">
       ...
       <div class="content-wrapper">
        ...
        <section class="content-header" >
          <h1><span style="color:#FF7634;"><?php echo $site_title;?></span>-編輯影片</h1>  
        </section>
        <!-- 主要內容 -->
              ...
              <form id="infoForm" method="post" action="" class="form-horizontal">
                ...
                <div class="input-group date">
                 ...
                 <div class="control-group">      
                    ...
                    <input id="video_part"  type="text" name="video" class="form-control" value="<?php echo $url;?>">      
                 </div> 
                <br>
                <div id="result"></div>
       ...
       result_content="";
        ...
        if(!$('input[name="name"]').val()) {
          ...
          $.ajax({
            ...
            data:{action:'update',title:name,token:token,url:url,thumb:thumb,type:'video',caption:caption,date:date,id:id},
            type : "POST",
