...
//取得最新消息資訊
$infos=getAllMilestones($db,$type); 
  ...
  <body class="hold-transition skin-yellow-light">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1><span style="color:#FF7634;"><?php echo $site_title;?></span>-大紀事管理</h1>  
        </section>
        <!-- 主要內容 -->
        <section class="content">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">大紀事列表</h3>
              <div class="text-right"> 
               <a class="fancybox fancybox.iframe" href="milestone_add.php?token=<?php echo $token;?>&type=<?php echo $type;?>"><button class="btn btn-primary btn-sm"><i class="fa fa-fw fa-plus"></i></button></a>
              </div>    
            </div>
            <div class="box-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td id="<?php echo $info["news_id"];?>" name="<?php echo $info["title"];?>">
                      <button class="btn btn-primary btn-sm"  data-toggle="tooltip" title="編輯" onclick="window.location='milestone_edit.php?info_id=<?php echo $info["milestone_id"]; ?>&type=<?php echo $type;?>&token=<?php echo $token;?>';"><i class="fa fa-pencil-square-o"></i></button>
    ...
    $(document).ready(function() {
        ...
        $(".delete").click(function() {
          ...
          var milestone_id=$(this).parent().attr('id');         
          ...
          $.confirm({
            ...
            confirm: function(button) {
                ...
                $.ajax({
                  ...
                  data:{action:'delete',id:milestone_id,token:token},
                  type : "POST",
